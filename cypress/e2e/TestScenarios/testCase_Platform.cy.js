...
describe('Test case - Platform menu item', () => {
	...
	it('Visit gamanza and open Platform', () => {
		...
		it('Open Data Vault', () => {
			...
			cy.get('.vc_single_image-img attachment-large').find('img').should('have.attr','src').should('include','https://gamanza.com/wp-content/uploads/2021/03/datavault-locket-smallertinyjpg.png')
